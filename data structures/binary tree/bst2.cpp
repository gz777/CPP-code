...
//12/2/19 added myMax(), yourMax() functions, used by getHeight()
...
class BST {
  ...
  public:
    ...
    constexpr const T& yourMax(const T& a, const T& b) {
        return (a>=b)?a:b;
    }
	...
	*/
	    ...
	    if (p  == nullptr)
	        ...
	        return 1 + yourMax(getHeight(p->left),getHeight(p->right));
